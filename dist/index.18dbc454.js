...
const observer = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        if (entry.isIntersecting) {
            if (entry.target.classList.contains("section-home")) entry.target.classList.add("animation-observer");
...
inputField.forEach((el1)=>{
    el1.closest(".animated").addEventListener("click", function(e) {
        inputField.forEach((el)=>{
            el.classList.remove("border__bottom-animation");
        });
        el1.classList.add("border__bottom-animation");
    });
});
//////send message
...
},{"./enums.js":"lCAq5","./modifiers/index.js":"cap3W","./createPopper.js":false,"./popper.js":false,"./popper-lite.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lCAq5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jQVXF","1SICI"], "1SICI", "parcelRequireba90")
